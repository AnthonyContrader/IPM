...
public interface EnvironmentPacketRepository extends CrudRepository<EnvironmentPacket, Long>{

		EnvironmentPacket findByEnvironmentAndPacket (Environment environment, Packet packet);	
}